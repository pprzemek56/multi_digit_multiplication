...
def print_multiplication(a, b):
    ...
    while y >= 0:
        while x >= 0:
            if counter == 0 and a_len > -1:
                multiplication_array[y][x] = a_list[a_len]
                a_len -= 1
            elif counter == 1 and b_len > -1:
                multiplication_array[y][x] = b_list[b_len]
                b_len -= 1
            x -= 1
        if counter == 2:
            a_list.reverse()
    ...
    print(" " * (len(multiplication_array[0])), main_product)
